...
// Quicksort subroutine to sort elements in decreasing order
...
void approximateBinPacking(vector<float>& items, float binCapacity) {
    ...
    // Sort the items in decreasing order using quicksort
    ...
    ofstream fout("binpacking10000_7.out");
...
int main() {
    ...
    ifstream fin("binpacking10000_7.in");
    fin >> n;
    cout << n  << "\n";
    binCapacity = 1;
    cout << binCapacity << "\n";
